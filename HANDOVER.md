...
| 10a | ~~Fifteen colours~~ **Resolved: all 15 are now purchasable** (client confirmed the studio shots are the same collection, Sep 2026) | `data.js` → `PRODUCTS` | 14 products / 15 colourways in the grid. The eight new product names (PUCUK, BAYU, SERI, KARANG, MAHSURI, MALAM, DIRAJA, MEKAR) are proposed like the originals. Two supplied looks were left out: `…503237` and `…503238` appear to be a different cut (buttoned jubah style, no close-up pair) — including them would make 17, not 15. Confirm they are a different product. |
